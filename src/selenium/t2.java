...
//		System.out.println(list.get(i).getText());
				if (list.get(i).getText().contains("-")) {
					...
					for (String b : arr) {
						...
						if (year > 2012) {
							...
							System.out.println(year + "מ2012 לא גדול");
							counter++;
						}
					}
				}
			...
			System.out.println("���� ������ ������ ���� �-2012:" + counter);
		...
		try {
			...
			System.out
					.println(driver.findElement(By.xpath("//ul[@class='review-list']//li[1]//div/span[1]")).getText());
			System.out
					.println(driver.findElement(By.xpath("//ul[@class='review-list']//li[2]//div/span[1]")).getText());
			System.out
					.println(driver.findElement(By.xpath("//ul[@class='review-list']//li[3]//div/span[1]")).getText());
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			...
			driver.findElement(By.id("searchboxinput")).sendKeys("�������");
		...
		try {
			...
			driver.findElement(By.id("searchboxinput")).sendKeys("�������");
			driver.findElement(By.id("searchbox-searchbutton")).click();
			WebElement myWebElement = (new WebDriverWait(driver, 10))
					.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id='pane']//h1/span[1]")));
			System.out.println(driver.findElement(By.xpath("//div[@id='pane']//h1/span[1]")).getText());
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		...
		try {
			driver.get(
					"http://tiran-bank.co.il/%d7%9e%d7%97%d7%a9%d7%91%d7%95%d7%9f-%d7%94%d7%9e%d7%a8%d7%aa-%d7%9e%d7%98%d7%91%d7%a2/");
			driver.manage().window().maximize();
			Thread.sleep(1000);
			driver.switchTo()
					.frame(driver.findElement(By.xpath("//*[@id=\"sitemain\"]/section[1]/div/div/div/div[2]/iframe")));
