...
public class t7_3 {
	...
	public void test001() throws InterruptedException, IOException, AWTException {
		...
		if (driver.getTitle().equals("אוכלוסיות ייחודיות")) {
			 ...
			 test.fail("gurden - link 1",MediaEntityBuilder.createScreenCaptureFromPath(exm.CaptureScreen(driver)).build());
		}
		 Thread.sleep(3000);	
	}
	...
	public void test002() throws InterruptedException, IOException, AWTException {
		...
		if (driver.getTitle().equals("הורות - הורים וילדים")) {
			 ...
			 test1.fail("gurden - link 2",MediaEntityBuilder.createScreenCaptureFromPath(exm.CaptureScreen(driver)).build());
		}
		 Thread.sleep(3000);
	...
	public void test003() throws InterruptedException, IOException, AWTException {
		...
		if (driver.getTitle().equals("יוזמות חינוכיות ורפורמות")) {
			 ...
			 test2.fail("gurden - link 3",MediaEntityBuilder.createScreenCaptureFromPath(exm.CaptureScreen(driver)).build());
		}
		 Thread.sleep(3000);
	}
	@Test
	public void test004() throws InterruptedException, IOException, AWTException {
		...
		if (driver.getTitle().equals("מחוץ לגן")) {
			 ...
			 test3.fail("gurden - link 4",MediaEntityBuilder.createScreenCaptureFromPath(exm.CaptureScreen(driver)).build());
		}
		 Thread.sleep(3000);
	}
	@Test
	public void test005() throws InterruptedException, IOException, AWTException {
		...
		if (driver.getTitle().equals("מקצועות ותחומי לימוד")) {
			 ...
			 test4.fail("gurden - link 5",MediaEntityBuilder.createScreenCaptureFromPath(exm.CaptureScreen(driver)).build());
		}
		 Thread.sleep(3000);
	}
	@Test
	public void test006() throws InterruptedException, IOException, AWTException {
		...
		if (driver.getTitle().equals("תקנות ומינהלות")) {
			 ...
			 test5.fail("gurden - link 6",MediaEntityBuilder.createScreenCaptureFromPath(exm.CaptureScreen(driver)).build());
		}
		 Thread.sleep(3000);
	}
	@Test
	public void test007() throws InterruptedException, IOException, AWTException {
		...
		if (driver.getTitle().equals("צפייה בציוני בחינות הבגרות")) {
			 ...
			 test6.fail("service - link 1",MediaEntityBuilder.createScreenCaptureFromPath(exm.CaptureScreen(driver)).build());
		}
		 Thread.sleep(3000);
	}
	@Test
	public void test008() throws InterruptedException, IOException, AWTException {
		...
		if (driver.getTitle().equals("תיק תוכניות לימודים לעובדי הוראה")) {
			 ...
			 test7.fail("service - link 2",MediaEntityBuilder.createScreenCaptureFromPath(exm.CaptureScreen(driver)).build());
		}
		 Thread.sleep(3000);
	}
	@Test
	public void test009() throws InterruptedException, IOException, AWTException {
		...
		if (driver.getTitle().equals("פניות ותלונות הציבור")) {
			 ...
			 test8.fail("service - link 3",MediaEntityBuilder.createScreenCaptureFromPath(exm.CaptureScreen(driver)).build());
		}
		 Thread.sleep(3000);
	}
}
