...
public class t1 {
	...
	public void test1() throws InterruptedException {
		if (browserName.equals("chrome")) {
			List<WebElement> jobsElements = driver
					.findElements(By.xpath("//div[3]/section[1]/section/section[2]/div/div/div[7]/div/h3"));
	...
	@Test(groups = "list", enabled = true)
	public void test2() throws InterruptedException {
		if (browserName.equals("chrome")) {
			List<WebElement> jobsElements = driver
					.findElements(By.xpath("//div[3]/section[1]/section/section[2]/div/table/tbody/tr/td/span/a/span"));
			for (WebElement webElement : jobsElements) {
				System.out.println(browserName + ":" + webElement.getText());
			}
		}
	...
	@Test(groups = "average", enabled = true)
	public void test3() {
		int avgSalaery = 0;
		if (browserName.equals("chrome")) {
			...
			while (numTables <= 5) {
				...
				List<WebElement> salaryList = driver
						.findElements(By.xpath("//div[3]/section[1]/section/section[2]/div/div/div[7]/div[" + numTables
								+ "]/table/tbody/tr/td[2]"));
